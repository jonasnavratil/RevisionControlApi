...
{
    public abstract class RevisionControlWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static RevisionControlWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(RevisionControlWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<RevisionControlDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<RevisionControlDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<RevisionControlDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<RevisionControlDbContext, Task<T>> func)
        {
            T result;
