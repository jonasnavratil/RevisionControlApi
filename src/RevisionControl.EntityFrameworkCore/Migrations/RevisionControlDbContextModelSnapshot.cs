...
{
    [DbContext(typeof(RevisionControlDbContext))]
    partial class RevisionControlDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Abp.Localization.ApplicationLanguageText", b =>
                {
                    ...
                    b.Property<string>("Value")
                        ...
                        .HasColumnType("character varying(10485759)");
            ...
            modelBuilder.Entity("RevisionControl.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("RevisionControl.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("RevisionControl.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("RevisionControl.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("RevisionControl.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("RevisionControl.Authorization.Roles.Role", b =>
                {
                    b.HasOne("RevisionControl.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("RevisionControl.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("RevisionControl.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
